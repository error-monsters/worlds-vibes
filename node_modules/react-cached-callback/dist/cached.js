    ...
    return function (prototype, name, descriptor) {
        return {
            ...
            value: function () {
                ...
                var cache4Function = common_1.getCache(this[cachedFunctionFieldName], name, getCacheKey.apply(void 0, args));
                if (!cache4Function) {
                    cache4Function = {};
                    ...
                    common_1.setCache(this[cachedFunctionFieldName], name, getCacheKey.apply(void 0, args), cache4Function);
                }
                if (!pure || !common_1.arraysEqual(args, cache4Function.args)) {
